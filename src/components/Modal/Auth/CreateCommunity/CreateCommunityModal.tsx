import { Text, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Box, Divider, Input, Stack, Checkbox, Flex, Icon } from '@chakra-ui/react';
    ...
    const handleCreateCommunity = async () => {
        ...
        try {
            ...
            if (communityDoc.exists()){
                throw new Error(`Sorry, r/${communityName} is already taken. Please try another community name.`)
                        ...
                        <Stack spacing={2}>
                            ...
                            <Checkbox name='private' isChecked={communityType === "private"} onChange={onCommunityTypeChange} >
                                <Flex align="center">
                                    ...
                                    <Text fontSize="8pt" color="gray.500" pt={1} > Only approved users can view, post and comment to this community </Text>
                                </Flex>
                            </Checkbox>
